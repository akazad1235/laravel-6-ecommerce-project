                            ...
                            <div class="drop-content">
                                <div class="widget-list list-left-element">
                                    <ul>
                                        <li>
                                            <a href="#">
                                                <div class="left-element"><img alt="profile" src="{{ asset('public/admin/images/avatar/avatar_1.jpg')}}" /></div>
                                                <div class="text">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="left-element"><img alt="profile photo" src="{{ asset('public/admin/images/avatar/avatar_2.jpg')}}" /></div>
                                                <div class="text">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        <div class="user-photo">
                            <img alt="profile" src="{{ asset('public/admin/images/avatar/avatar_user.jpg')}}" />
                        </div>
                        <div class="user-info">
                    ...
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                <!--HOME-->
                                <li class="{{ request()->is('admin') ? 'active-item': '' }}"><a href="{{route('dashboard')}}"><i class="fa fa-home" aria-hidden="true"></i><span>Dashboard</span></a></li>
                                <!--UI ELEMENTENTS-->

                                <!-- Brand -->
                                <li class="has-child-item close-item {{ request()->is('brand/*') ? 'open-item': '' }}">
                                    <a><i class="fa fa-user-plus" aria-hidden="true"></i><span>Brand</span></a>
                                    <ul class="nav child-nav level-1">
                                        <li class="has-child-item close-item {{ request()->is('brand/add-brand') ? 'active-item': '' }}"><a href="{{ route('addBrand')}}">add brand</a></li>
                                        <li class="has-child-item close-item {{ request()->is('brand/manage-brand') ? 'active-item': '' }}"><a href="{{ route('manageBrand')}}">Manage brand</a></li>
                                    </ul>
                                </li>
