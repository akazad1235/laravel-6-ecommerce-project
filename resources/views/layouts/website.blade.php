...
<head>
	    ...
	    <link rel="stylesheet" href="{{asset('public/website/css/blue.css')}}">
		...
		<link rel="stylesheet" href="{{asset('public/website/css/rateit.css')}}">
		<link rel="stylesheet" href="{{asset('public/website/css/bootstrap-select.min.css')}}">

		

		
		<!-- Icons/Glyphs -->
		<link rel="stylesheet" href="{{asset('public/website/css/font-awesome.css')}}">
...
<!-- ============================================================= FOOTER : END============================================================= -->
	...
	<script src="{{asset('public/website/js/bootstrap-hover-dropdown.min.js')}}"></script>
	<script src="{{asset('public/website/js/owl.carousel.min.js')}}"></script>
	
	<script src="{{asset('public/website/js/echo.min.js')}}"></script>
	<script src="{{asset('public/website/js/jquery.easing-1.3.min.js')}}"></script>
	<script src="{{asset('public/website/js/bootstrap-slider.min.js')}}"></script>
    <script src="{{asset('public/website/js/jquery.rateit.min.js')}}"></script>
    <script type="{{asset('public/website/javascript" src="assets/js/lightbox.min.js')}}"></script>
    <script src="{{asset('public/website/js/bootstrap-select.min.js')}}"></script>
    <script src="{{asset('public/website/js/wow.min.js')}}"></script>
	<script src="{{asset('public/website/js/scripts.j')}}s"></script>
